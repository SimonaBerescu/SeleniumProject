...
public class LoginTests {
    ...
    public void login(String user, String password) {
        ...
        //implicit wait
        //o folosim cand asteptam incarcarea in pagina a unui element
        //driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(5));

        //explicit wait
        //- asteapta pana cand elementul este clickable
        //WebElement loginButton = new WebDriverWait(driver, Duration.ofSeconds(10))
         //       .until(ExpectedConditions.elementToBeClickable(By.cssSelector("i.fa-sign-in")));
        loginButton.click();
